# Generated by Django 2.0 on 2019-05-07 21:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_abort', models.BooleanField(default=False, verbose_name='是否删除')),
                ('category', models.ForeignKey(blank=True, limit_choices_to={'is_abort': False}, null=True, on_delete=django.db.models.deletion.CASCADE, to='product.Category', verbose_name='分类')),
            ],
            options={
                'verbose_name': '产品',
